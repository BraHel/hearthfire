...
export const MINOR_ARCANA: MinorArcanum[] = [
  {
    ...
    weight: 1,
    description:
      "A leather scroll case, cracked and age-worn. Inside is a tattered letter and a pair of small, bluish ingots. It's a letter, in an older Hillfolk dialect, from an apprentice to their master. It describes a mental exercise to draw latent power from aetherium.\n\nYou can learn **Laoj Daveth's Galvanic Infusion** from the scroll, but…",
    requirements: [
  ...
  },
  {
    ...
    tags: "magical",
    description:
      "In a ruin of the Stone Lords is an old dwelling that bears the psychic imprint of its inhabitant, a stoneshaper of some considerable skill.\n\nWhen you *enter the dormitory*, you are overcome with a vision of this student inventing his first spell. You can learn this spell, but…",
    requirements: [
  ...
  },
  {
    ...
    weight: 1,
    description:
      "Found on a skeleton that has been stripped clean of flesh and that bears what can only be described as bite marks all along its bones. Close inspection of the mantle reveals sigils woven in silvery thread and human teeth sewn into the fringe like decorative beads.\n\nYou can unlock the power of this mantle by…",
    requirements: [
  ...
  },
  {
    ...
    move: {
      ...
      follower: {
        ...
        armor: 1,
        damage:
          "feast on fear d6 (*hand*, *close*, ignores armor, disadvantage)",
  ...
  },
  {
    ...
    tags: "magical",
    description:
      "This simple, golden band catches the light and shines, even in darkness. Its very presence fills goodly people with peace and hope, and servants of darkness with jealous hate.\n\nYou can unlock the secrets of this ring, but must first…",
    requirements: [
  ...
  },
  {
    ...
    weight: 1,
    description:
      "About 6 feet long, waxy and rigid, shimmering with golden iridescence. Is this truly a leaf from the Golden Oak?\n\nYou can turn the leaf into a wondrous cloak, but to do so you must…",
    requirements: [
  ...
  },
  {
    ...
    move: {
      ...
      subtitle: "◊ pouch of powdered cinnabar (Value 2)",
      tracker: { label: "uses", max: 9 },
  ...
  },
  {
    ...
    tags: "magical",
    description:
      "High in the hills or mountains, a pair of massive stone doors are set into the hillside. The markings outside are faded and covered in lichen. The doors aren't locked; one lies a bit ajar. Inside, the vault and its contents are untouched by time, free of dust or mold. Clearly some magic is afoot.\n\nTo unlock the secrets of this place's stasis…",
    requirements: [
  ...
  },
  {
    ...
    tags: "magical",
    description:
      "High in the hills or mountains, one can find a bricked-over cave mouth. Inside lie dozens of corpses, preserved for centuries by the cold. Many have malformations in the jaw, oversized teeth, elongated fingers that taper to claws. Few show signs of violence; they appear to have just laid down and died.\n\nIndeed, the looping glyphs carved all over the cave walls sap your will to struggle, to fight, to do much of… anything. You can learn their mysteries, but…",
    requirements: [
  ...
  },
  {
    ...
    description:
      "Secreted away in some Makers' trove is a gleaming white thing, like a key, I guess, but not a specific key, more like the *idea* of keyness. Hurts to look right at it; makes you aware of your own dying flesh.\n\nYou don't unlock this key's mysteries, so much as it unlocks you. But only if you…",
    requirements: [
  ...
  },
  {
    ...
    tags: "magical",
    description:
      "On a rare dry spot in Ferrier's Fen, besieged by foulness, is an ancient arch that still—improbably—stands. Lichen and moss grow thick and healthy, but the keystone remains clear, engraved with a sigil that makes the eyes water and that drives evil away.\n\nYou can learn the secrets of the sanctifying mark, but to do so you must…",
    requirements: [
  ...
  },
  {
    ...
    weight: 1,
    description:
      "An exquisitely fine wool, dyed a pale blue-gray and embroidered with stylized clouds. The edge boasts blue-white runes stitched with aetherium wire. It feels damp, smells of rain and ozone, and flutters in a breeze that isn't there.\n\nWhen you **don the cloak**, you become aware of the presence bound within, thrumming and impatient. To unlock the mysteries of the cloak, you must…",
    requirements: [
  ...
  },
  {
    ...
    tags: "immobile",
    description:
      "A big old chunk of stone, maybe 5 feet across, covered in mud and algae. There are Maker-runes on it, barely visible. Runes for the earth, and spirits, and rejuvenation.\n\nThe tablet reveals the workings for a ritual, which you can learn if you…",
    requirements: [
  ...
  },
  {
    ...
    tags: "immobile, magical",
    description:
      "Big enough for a grown man to crawl inside, pitted and scratched, engraved with whorly rune-like patterns. The whole thing is caked with rust. At least, you hope that's rust.\n\nThe thing has a sinister feel, and you can sense its power. To unlock the cauldron's mysteries, you must…",
    requirements: [
  ...
  },
  {
    ...
    weight: 2,
    description:
      "30 inches tall and carved of yew, with a lid shaped like a horned lion and sealed with wax. Its surface is cracked and speared with shards of red crystal. When you touch it, you can feel great annoyance and just a hint of fear.\n\nTo unlock the jar's mysteries, you must…",
    requirements: [
    ...
    requirementsNote: "If **the jar is opened**, all its magic is lost.",
    move: {
  ...
  },
  {
    ...
    weight: 2,
    description:
      "A cylinder about 4 feet long and 3 inches wide, the glass surprisingly thin. It rings with a rich, sonorous chime when struck softly. When struck firmly, the sound is almost deafening and causes a rippling pattern to appear on the surface of nearby stone, crystal, or mundane glass.\n\nThe chime is a powerful tool, if you can unlock its secrets. To do so…",
    requirements: [
  ...
  },
  {
    ...
    weight: 1,
    description:
      "A jar of fine pottery, the size of a small cookpot. Its glaze is a wondrous blend of patterns and sheens. The lid fits snugly, though it's clumsy to manipulate and tricky to open once closed. You get the feeling it was made for much bigger hands than yours.\n\nTo unlock the secrets of the urn, you must…",
    requirements: [
  ...
  },
  {
    ...
    weight: 1,
    description:
      "A cord almost 10 feet long, strung with bronze beads. Each bead is carved with a different glyph and a figure in a unique meditative pose. If you run your fingers along the beads, you feel a sense of stillness—but also a merciless weight of judgement.\n\nTo unlock the secrets of the prayer beads, you must…",
    requirements: [
  ...
  },
  {
    ...
    weight: 1,
    description:
      "Inside a case of carved ivory rests a scroll made of fine, almost gauzy wool. It is full of glyphs and diagrams, imprinted with rich dyes of red and black and yellow. The diagrams seem to depict some sort of meditative practice, resulting in some kind of familiar spirit?\n\nTo unlock the mysteries of this scroll, you must…",
    requirements: [
    ...
    move: {
      ...
      follower: {
        ...
        loyalty: 3,
        cost: "respect given / new experiences / comfort/compassion",
      },
    },
  },
  {
    ...
    weight: 2,
    description:
      "An oversized, highly decorated lamp, shaped like a chalice with a wide cup, like those lamps they use up north to burn mammoth-butter in their rituals.\n\nIt's worth a fortune (Value 4), but there's more to this lamp than meets the eye. To unlock its secrets, you must…",
    requirements: [
  ...
  },
  {
    ...
    name: "A creepy cave",
    description:
      "There's a cave somewhere—somewhere that the light never shines—where the walls are roiling formations, slick and wet, glinting with veins of red crystal that no longer glows. The stone undulates in the flickering torchlight. Yes, yes, that must be it… a trick of the light, nothing more.\n\nThe cave bears the lingering taint of a Thing Below, but has been cut off from its power. To unlock its secrets, you must…",
    requirements: [
  ...
  },
  {
    ...
    tags: "magical",
    description:
      "This stiff, leathery mask looks a bit like melted wax. A large pearlescent sphere is embedded in the forehead. It seems to whisper as you move to put it on.\n\nThere's more to this mask than meets the eye. To unlock its secrets, you must…",
    requirements: [
  ...
  },
  {
    ...
    weight: 1,
    description:
      "A remarkably supple scroll, given its age, found in an ivory tube. It bears writing in a strange alphabet, penned in a dark red ink. There are diagrams, too. You think it might be some sort of recipe? Or spell? Maybe both?\n\nTo unlock the secrets of this scroll, you must…",
    requirements: [
  ...
  },
  {
    ...
    description:
      "Hidden from the sun, in a ring of runes, there is a… word?… floating in the air. Squiggling and wriggling, yearning to be free, it whispers promises of power. But the runes around it fill you with dread.\n\nTo unlock its secrets, you must…",
    requirements: [
  ...
  },
  {
    ...
    weight: 1,
    description:
      "Hidden away in some vault or cave or Maker-ruin is a length of copper, heavily corroded and coated with chunks of verdigris. If you squint, you vaguely make out the shape of a spearhead. Oh, and are those the faint traces of runes?\n\nTo unlock the secrets of this ancient weapon, you must…",
    requirements: [
  ...
  },
  {
    ...
    weight: 1,
    description:
      "A short staff, about 4 feet tall, tapering towards the tip and made of blackened oak with a strange metallic sheen. A dozen bands adorn it, made of corroded copper, caked in verdigris and crumbling away in spots. The bands are embossed with runes of power, some of them worn away or obscured.\n\nThe staff still tingles with power. To unlock its mysteries you must…",
    requirements: [
  ...
  },
  {
    ...
    weight: 1,
    description:
      "A short flatbow made of pale blue metal, rigid and gracefully curved even though it's unstrung. There aren't even hooks where you *could* attach a string.\n\nIt seems to be of little use, but there is more to this bow than meets the eye. To unlock its mysteries, you must…",
    requirements: [
  ...
  },
  {
    ...
    weight: 1,
    description:
      "It was clearly once a fine, fine blade. The steel holds a pattern of rune-like sworls, at least where the rust hasn't taken over. The hilt is blackened, with hints of leather wrappings that long ago burned away. The metal is hot to the touch, like it's been left out for hours in the summer sun.\n\nTo unlock the mysteries of this weapon, you must…",
    requirements: [
  ...
  },
  {
    ...
    weight: 1,
    description:
      "Found in the workshop of some Forge Lord, still held in a vice-clamp. The head is a runic shape, 6 by 6 inches, with smaller runes etched into its surface. Or at least, most of its surface. A few inches are blank, the work clearly unfinished.\n\nTo unlock the mysteries of this iron and claim its power as your own, you must…",
    requirements: [
  ...
  },
  {
    ...
    tags: "magical, beautiful",
    description:
      "A ring of white metal, untarnished and gleaming, a single glyph carved into the bezel. The symbol squirms under your gaze, like it exists in more dimensions than you can perceive. The ring fits you perfectly, of course.\n\nTo unlock the ring's mysteries, you must…",
    requirements: [
  ...
  },
  {
    ...
    weight: 1,
    description:
      "You got it off a stranger. Like, maybe on a bet, or in a contest, or as a gift in return for some kindness. Or maybe you took it without his consent? Regardless, he seemed a bit coy about the horn, almost glad to let you have it. And just before you parted ways, you noticed the missing finger on his left hand.\n\nSince then, the horn has seemed to call to you, daring you to drink heavily from it. To unlock its mysteries, you must…",
    requirements: [
  ...
  },
  {
    ...
    description:
      "Found in a cave, a mountain, or some rocky outcrop, likely considered sacred by the locals. It looks like cloudy white quartz, but glows faintly at night.\n\nYou can unlock the mysteries of this vein and craft a talisman against the undead, but to do so you must…",
    requirements: [
  ...
  },
  {
    ...
    weight: 2,
    description:
      "A wide, shallow bowl carved with flowers and thorny vines, twining through skulls of deer and other beasts. The pattern shifts when you aren't looking; it's never exactly the same twice.\n\nTo unlock the mysteries of the basin, you must…",
    requirements: [
  ...
  },
  {
    ...
    weight: 1,
    description:
      "Just a well-worn stick of rowan wood, in need of some new bristles. You wouldn't give it another thought. Except… when you hold it, and sweep with it, you find yourself humming a half-remembered tune.\n\nClearly, there is more to this broom than meets the eye. To unlock its mysteries, you must…",
    requirements: [
  ...
  },
  {
    ...
    weight: 1,
    description:
      'Found at the back of some cave or grotto, obscured by roots and rubble, surrounded by desiccated, rotting offerings. A crude squat thing with a possum\'s sneering face, a thorny tail, and flowers for its ears.\n\nThe idol is, in fact, a narcissistic little Fae, stuck (hiding? stubbornly ensconced?) in the form of a stone idol. To unlock its "mysteries" and benefit from its patronage, you must…',
    requirements: [
  ...
  },
  {
    ...
    tags: "fragile",
    description:
      "A tattered scrap of parchment. It shows a path from a particular set of standing stones: through a marsh, up a river, to a place behind a waterfall, then through a forest of sword-sharp trees. Forest Folk glyphs are scrawled all about, but at the end: a silver tree, and X marks the spot.\n\nTo unlock the map's mysteries and claim the prize at the end, you must…",
    requirements: [
  ...
  },
  {
    ...
    weight: 1,
    description:
      "A circlet of black, glossy metal set with eight spires of aetherium. It's sized for a head maybe twice as large as yours, and is always a bit chill to the touch. Even cast into the hottest furnace, it will not melt nor even heat.\n\nWhen you **touch the crown with bare flesh and open your mind**, you can speak to the primordial spirit to which the crown is attuned. But to fully unlock the mysteries of this crown, you must…",
    requirements: [
    ...
    move: {
      ...
      follower: {
        ...
        // No follower-level loyalty here: this move already carries its own "Loyalty" tracker, and
        // adding one to the follower would render a second, separate row for the same three dots.
      },
    },
  },
  {
    ...
    weight: 1,
    description:
      'A 6" cube of dull gray metal, covered in hinges, knobs, dials, sliders, levers, and the like. A thing of mad genius, resisting all attempts to open it by brute force.\n\nTo unlock its mysteries, you must…',
    requirements: [
